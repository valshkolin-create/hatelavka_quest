...
function renderChallenge(challengeData, isGuest) {
   ...
   async function refreshDataSilently() {
    // --- 🔍 ЛОВУШКА ДЛЯ ОТЛАДКИ ---
    console.group("🕵️‍♂️ DETECTIVE MODE");
    console.log("⏰ Heartbeat сработал в:", new Date().toLocaleTimeString());
    console.trace("Кто меня вызвал? (Нажми сюда, чтобы увидеть строку)"); 
    console.groupEnd();
    // -----------------------------
    // --- ВАЖНОЕ ИСПРАВЛЕНИЕ ---
