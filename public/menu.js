...
    // 🔥 ПЛАШКИ: Отдельно для монет (черная, сбоку) и билетов (белая, рядом)
    const multiplierBadgeCoins = trustMultiplier > 1 
        ? `<span style="position: absolute; right: 8px; background: rgba(255,255,255,0.5); color: #000; padding: 2px 4px; border-radius: 4px; font-size: 9px; font-weight: 900; border: 1px solid rgba(0,0,0,0.15);">x${trustMultiplier}</span>` 
        : '';
        
...
                            <i class="fa-solid fa-coins" style="font-size: 11px; color: #000 !important; filter: none !important; text-shadow: none !important;"></i>
